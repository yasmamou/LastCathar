...
export const EPICS: Epic[] = [
  ...
  {
    id: 'forteresses-royales',
    title: 'Les Forteresses royales du Languedoc',
    subtitle: 'Le rideau de citadelles des rois de France — inscrit à l\'UNESCO (2026)',
    description: "En juillet 2026, l'UNESCO a inscrit au patrimoine mondial les Forteresses royales du Languedoc : un bien en série de huit sites. Après la croisade contre les Albigeois, les rois capétiens s'emparèrent de ces châteaux cathares et les reconstruisirent en un formidable système défensif, verrou du Languedoc annexé et sentinelle de la frontière avec l'Aragon. Autour de la Cité de Carcassonne — déjà classée depuis 1997 — sept citadelles perchées sur des éperons vertigineux illustrent le génie des bâtisseurs du XIIIᵉ siècle : Aguilar, Lastours, Montségur, Peyrepertuse, Puilaurens, Quéribus et Termes. De la résistance cathare à la forteresse royale, chacune raconte plusieurs vies.",
    icon: '⚜️',
    color: '#4a6fa5',
    tags: ['unesco', 'patrimoine mondial', 'forteresses royales', 'citadelles du vertige', 'languedoc', 'cathare', 'châteaux', 'carcassonne', 'aragon', 'capétiens'],
    places: [
      { slug: 'cite-de-carcassonne', role: 'Le cœur du bien en série — cité royale, déjà inscrite à l\'UNESCO depuis 1997', order: 1, date: '1997 / 2026' },
      { slug: 'chateau-de-lastours', role: 'Les quatre châteaux de Cabaret — foyer cathare reconstruit en place royale', order: 2, date: 'XIIIᵉ s.' },
      { slug: 'chateau-de-termes', role: 'Pris après quatre mois de siège, intégré au dispositif royal', order: 3, date: 'XIIIᵉ s.' },
      { slug: 'chateau-daguilar', role: 'Sentinelle des Corbières — poste avancé de la couronne face à l\'Aragon', order: 4, date: 'XIIIᵉ s.' },
      { slug: 'chateau-de-queribus', role: 'Dernier bastion cathare (1255), devenu forteresse royale de frontière', order: 5, date: '1255' },
      { slug: 'chateau-de-peyrepertuse', role: 'La « Carcassonne céleste » — la plus vaste des forteresses royales', order: 6, date: 'XIIIᵉ s.' },
      { slug: 'chateau-de-puilaurens', role: 'Verrou stratégique contrôlant l\'accès aux Pyrénées', order: 7, date: 'XIIIᵉ s.' },
      { slug: 'chateau-de-montsegur', role: 'Site emblématique de la fin cathare (1244), rebâti par le roi', order: 8, date: '1244' },
    ],
  },
  {
    id: 'croisade-cathare',
