...
export const EPICS: Epic[] = [
  ...
  },
  {
    ...
    places: [
      ...
      { slug: 'bibliotheque-alexandrie', role: 'Ératosthène y calcula la circonférence de la Terre, Euclide y écrivit les Éléments', order: 2, date: 'IIIe siècle av. J.-C.' },
      { slug: 'cordoue-mosquee-cathedrale', role: 'Cordoue — Averroès transmit Aristote à l\'Occident, carrefour du savoir arabe et grec', order: 3, date: 'XIIe siècle' },
      { slug: 'tolede-cite-trois-cultures', role: 'Tolède — l\'École de traducteurs transmit le savoir arabe et grec à l\'Europe médiévale', order: 4, date: 'XIIe siècle' },
    ],
  },
  {
    ...
    places: [
      ...
      { slug: 'bibliotheque-alexandrie', role: 'Ératosthène mesura la Terre, Aristarque proposa l\'héliocentrisme — les prémices', order: 2, date: 'IIIe siècle av. J.-C.' },
      { slug: 'cordoue-mosquee-cathedrale', role: 'Al-Khwarizmi et les mathématiques arabes — les outils qui permettront de calculer la gravité', order: 3, date: 'IXe siècle' },
      { slug: 'tolede-cite-trois-cultures', role: 'Gérard de Crémone traduit Ptolémée et Al-Khwarizmi — le savoir arrive en Europe', order: 4, date: 'XIIe siècle' },
    ],
  },
]
